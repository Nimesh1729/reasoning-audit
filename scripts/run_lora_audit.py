"""Run a LoRA fine-tuned seq2seq reasoning-audit experiment."""
...
from src.models.hf_lora_seq2seq_model import HFLoraSeq2SeqModel
...
def main() -> None:
        ...
        [
            {
                ...
                "astronomy_accuracy": accuracy_by_domain.get("astronomy", 0.0),
                "logic_accuracy": accuracy_by_domain.get("logic", 0.0),
    ...
    error_distribution_df.to_csv(error_distribution_path, index=False)
