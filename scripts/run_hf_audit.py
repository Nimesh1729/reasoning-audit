"""Run a Hugging Face model reasoning-audit experiment."""
...
from src.models.hf_seq2seq_model import HFSeq2SeqModel
...
def main() -> None:
    """Run Hugging Face audit pipeline."""
